...
-- FOREIGN KEYS
ALTER TABLE UBICACION ADD CONSTRAINT FK_UBICACION_ESCUELA
    FOREIGN KEY (ESCUELA_ID_ESCUELA) REFERENCES ESCUELA(ID_ESCUELA);

ALTER TABLE UBICACION ADD CONSTRAINT FK_UBICACION_CENTRO
    FOREIGN KEY (CENTRO_ID_CENTRO) REFERENCES CENTRO(ID_CENTRO);

ALTER TABLE REGISTRO ADD CONSTRAINT FK_REG_ESCUELA
    FOREIGN KEY (UBICACION_ESCUELA_ID_ESCUELA) REFERENCES ESCUELA(ID_ESCUELA);

ALTER TABLE REGISTRO ADD CONSTRAINT FK_REG_CENTRO
    FOREIGN KEY (UBICACION_CENTRO_ID_CENTRO) REFERENCES CENTRO(ID_CENTRO);

ALTER TABLE EXAMEN ADD CONSTRAINT FK_EXAMEN_REGISTRO
    FOREIGN KEY (REGISTRO_ID_REGISTRO) REFERENCES REGISTRO(ID_REGISTRO);

ALTER TABLE EXAMEN ADD CONSTRAINT FK_EXAMEN_CORRELATIVO
    FOREIGN KEY (CORRELATIVO_ID_CORRELATIVO) REFERENCES CORRELATIVO(ID_CORRELATIVO);

ALTER TABLE RESPUESTA_USUARIO ADD CONSTRAINT FK_RESP_EXAMEN
    FOREIGN KEY (EXAMEN_ID_EXAMEN) REFERENCES EXAMEN(ID_EXAMEN);

ALTER TABLE RESPUESTA_PRACTICO_USUARIO ADD CONSTRAINT FK_RESPPRAC_EXAMEN
    FOREIGN KEY (EXAMEN_ID_EXAMEN) REFERENCES EXAMEN(ID_EXAMEN);